    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('driver_car_driverlicense', models.ImageField(upload_to=user.models.DriverAcc.upload_to_func_driver_car_driverlicense)),
                ...
                ('driver_car_photo', models.ImageField(blank=True, null=True, upload_to=user.models.DriverAcc.upload_to_func_driver_car_photo)),
                ('driver_profile_tradeunion_certificate', models.FileField(blank=True, null=True, upload_to=user.models.DriverAcc.upload_to_func_driver_profile_tradeunion_certificate)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_business_registration', models.ImageField(upload_to=user.models.CompanyAcc.upload_to_func_company_business_registration)),
                ('company_profile_transportationbusiness_registration', models.ImageField(blank=True, null=True, upload_to=user.models.CompanyAcc.upload_to_func_company_profile_transportationbusiness_registration)),
                ('company_profile_tradeunion_certificate', models.FileField(blank=True, null=True, upload_to=user.models.CompanyAcc.upload_to_func_company_profile_tradeunion_certificate)),
